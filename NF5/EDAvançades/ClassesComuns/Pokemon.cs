...
namespace ClassesComuns
{
	public class Pokemon
	{
		...
		// Definim un GetHashCode que produirà moltes col·lisions i veurem que podem inserir els mateixos ID
		// en aquest cas retorna la longitud de la cadena del Id
		public override int GetHashCode()
		{
